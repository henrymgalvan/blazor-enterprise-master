...
namespace BethanysPieShopHRM.Api.Models
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Contact>().HasData(new Contact() { Id = 1, Email = "bethany@bethanyspieshop.com", PhoneNumber = "324777888773" });
            modelBuilder.Entity<Contact>().HasData(new Contact() { Id = 2, Email = "bob@bethanyspieshop.com", PhoneNumber = "55512312321" });
